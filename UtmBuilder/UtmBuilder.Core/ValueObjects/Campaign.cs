...
public class Campaign : ValueObject
{
        ...
        string? content = null)
    {
        ...
        InvalidCampagnException.ThrowIfNull(source, "Source is invalid");
        InvalidCampagnException.ThrowIfNull(medium, "Medium is invalid");
        InvalidCampagnException.ThrowIfNull(name, "Name is invalid");
